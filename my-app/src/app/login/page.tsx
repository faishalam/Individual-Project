    ...
    return (
        ...
        <section className="relative flex flex-wrap lg:h-screen lg:items-center bg-white">
            <div className="w-full px-4 py-12 sm:px-6 sm:py-16 lg:w-1/2 lg:px-8 lg:py-24">
                ...
                <form action={handleOnLogin} className="mx-auto mb-0 mt-8 max-w-md space-y-4">
                    <div>
            ...
            <div className="relative h-64 w-full sm:h-96 lg:h-full lg:w-1/2">
                <img
                    alt="Welcome"
                    src="https://spaces.ilfen.co/assets/image/produk/ce7f81d7-727f-4216-8dc4-036b3a4aa65c.jpeg"
